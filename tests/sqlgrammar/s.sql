exec  R21.insert 393, 0, 694, NULL, 1505034, NULL, -71.11874167, '7', '2a', 'yli%', 'b0', '{"JN4":[{"JN2":-9307.2e1}]}', NULL, x'66', NULL, PolygonFromText('POLYGON((-2 -2, 10 -2, -2 10, -2 -2),(-1 -1, -1 1, 3 -1, -1 -1))'), '144.227.88.67', NULL, x'0876C7B4', x'5D746b29655bB04919524944ccd7b5D0';
